function outputDoublets = findDoublets_20200925_resampleY(stdcutoff, numDoublets, shuffletoggle, fname, preprocessparam, inputRNG)
...
nic_output = extractVariables('all', 2, 'keepTrials', 1, 100, 0, config.stdcutoff, preprocessparam, fname,'none','towers',1,1);
