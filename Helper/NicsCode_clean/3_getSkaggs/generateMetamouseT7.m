function [metamouse] = generateMetamouseT7(argin1DFFthresholding, ...
    ...
    for i = 1:length(imagingFiles)
        ...
        if strcmp(input4trialsAverageMap, 'keepTrials + leftChoice')
            saveString = [animalID, '_', strDims,'_LC_[', ...
                num2str(argin1DFFthresholding(1)), '_', num2str(argin1DFFthresholding(2)), ']_T7_%d.mat'];
        end
...
if input15LR_split == 1
    metamouseLC = generateMetamouseT7(argin1DFFthresholding, input2log, input3gaussianSmoothing, ...
    ...
    metamouseRC = generateMetamouseT7(argin1DFFthresholding, input2log, input3gaussianSmoothing, ...
